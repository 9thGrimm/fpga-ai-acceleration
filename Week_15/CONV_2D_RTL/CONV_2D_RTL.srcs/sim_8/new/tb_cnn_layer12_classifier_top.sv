...
module tb_cnn_layer12_classifier_top;
  ...
  // ------------------------------------------------------------
  initial begin
    f_win             = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_windows.txt", "w");
    f_conv_raw        = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_conv_raw.txt", "w");
    f_conv            = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_conv_out.txt", "w");
    f_pool            = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_out.txt", "w");
    f_l2_full         = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_layer2_full_pipeline_out.txt", "w");
    f_classifier_full = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_15/rtl_classifier_full_pipeline_out.txt", "w");
    ...
    $display("\n==============================================");
    $display("Starting Week 15 full CNN pipeline test");
