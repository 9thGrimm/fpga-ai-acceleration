...
module tb_cnn_layer1_iq_top;
  ...
  // ---------------- File handles ----------------
  initial begin
    f_win      = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_12/rtl_windows.txt", "w");
    f_conv_raw = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_12/rtl_conv_raw.txt", "w");
    f_conv     = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_12/rtl_conv_out.txt", "w");
    f_pool     = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_12/rtl_out.txt", "w");
