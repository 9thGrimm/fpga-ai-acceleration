...
module tb_cnn_layer1_iq_top;
  ...
  // ------------------------------------------------------------
  initial begin
    f_win      = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_14/rtl_windows.txt", "w");
    f_conv_raw = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_14/rtl_conv_raw.txt", "w");
    f_conv     = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_14/rtl_conv_out.txt", "w");
    f_pool     = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_14/rtl_out.txt", "w");
    f_l2_full  = $fopen("C:/Users/sagar/Documents/FPGA_AI_STUFF/Week_14/rtl_layer2_full_pipeline_out.txt", "w");

    if (f_win == 0 || f_conv_raw == 0 || f_conv == 0 || f_pool == 0 || f_l2_full == 0) begin
    ...
    $display("\n==============================================");
    $display("Starting Week 14 full CNN pipeline test");
