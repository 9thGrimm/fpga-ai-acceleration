module conv2d_8x8_3x3 #(
  ...
  // Optional: expose row/col for debugging/scoreboarding
  ...
  // ---------------------------------------------------
  // NOTE: Image loading is left to the testbench for now.
  // In Week 3 Wednesday TB, we'll do:
  // - $readmemh into a 1D array, then map into img[r][c], OR
  // - direct hierarchical assignment (tb.dut.img[r][c] = ...)
  // ---------------------------------------------------
